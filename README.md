...
* [Agent Workflow Memory](https://arxiv.org/abs/2409.07429) (Sep. 2024)
  * [Code](https://github.com/zorazrw/agent-workflow-memory) ⭐ 457 | 🐛 4 | 🌐 Python | 📅 2025-12-22
...
* [Mobile-Agent-v2: Mobile Device Operation Assistant with Effective Navigation via Multi-Agent Collaboration](https://arxiv.org/abs/2406.01014) (Jun. 2024)
  * [Code](https://github.com/X-PLUG/MobileAgent) ⭐ 9,090 | 🐛 195 | 🌐 Python | 📅 2026-07-07
...
* [Cradle: Empowering Foundation Agents towards General Computer Control](https://arxiv.org/abs/2403.03186) (Mar. 2024)
  * [Code](https://github.com/BAAI-Agents/Cradle) ⭐ 2,566 | 🐛 22 | 🌐 Python | 📅 2024-11-07
...
* [UFO: A UI-Focused Agent for Windows OS Interaction](https://arxiv.org/abs/2402.07939) (Feb. 2024)
  * [Code](https://github.com/microsoft/UFO) ⭐ 9,496 | 🐛 77 | 🌐 Python | 📅 2026-08-10
...
* [WebVoyager: Building an End-to-End Web Agent with Large Multimodal Models](https://arxiv.org/abs/2401.13919) (Jan. 2024)
  * [Code](https://github.com/MinorJerry/WebVoyager) ⭐ 1,119 | 🐛 12 | 🌐 Python | 📅 2024-03-04
...
* [AppAgent: Multimodal Agents as Smartphone Users](https://arxiv.org/abs/2312.13771) (Dec. 2023)
  * [Code](https://github.com/mnotgod96/AppAgent) ⭐ 6,843 | 🐛 99 | 🌐 Python | 📅 2025-03-19
...
* [OmniParser for Pure Vision Based GUI Agent](https://arxiv.org/pdf/2408.00203) (Aug. 2024)
  * [Code](https://github.com/microsoft/OmniParser) ⭐ 25,267 | 🐛 231 | 🌐 Jupyter Notebook | 📅 2026-07-20
...
* [OSWorld: Benchmarking Multimodal Agents for Open-Ended Tasks in Real Computer Environments](https://arxiv.org/abs/2404.07972) (Apr. 2024)
  * [Code](https://github.com/xlang-ai/OSWorld) ⭐ 3,087 | 🐛 189 | 🌐 Python | 📅 2026-08-12
...
* [Auto-GPT](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,637 | 🐛 509 | 🌐 Python | 📅 2026-08-17
  * Autonomous GPT-4 agent
  * Task automation focus

* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 109,477 | 🐛 357 | 🌐 Python | 📅 2026-08-16
...
* [OpenInterpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,040 | 🐛 6 | 🌐 Rust | 📅 2026-08-17
  * General-purpose computer control framework
  * Python-based, extensible architecture

* [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,463 | 🐛 998 | 🌐 Python | 📅 2026-04-15
...
* [Skyvern](https://github.com/skyvern-ai/skyvern) ⭐ 22,767 | 🐛 218 | 🌐 Python | 📅 2026-08-17
  * AI web agent framework
  * Automate browser-based workflows with LLMs using vision and HTML extraction

* [Self-Operating Computer](https://github.com/OthersideAI/self-operating-computer) ⭐ 10,284 | 🐛 106 | 🌐 Python | 📅 2025-09-19 (Nov. 2023)
  * The first Computer Use framework created
  * Computer control framework
  * Vision-based automation

* [Upsonic](https://github.com/upsonic/upsonic) ⭐ 7,941 | 🐛 30 | 🌐 Python | 📅 2026-06-18
...
* [Open Source Computer Use by E2B](https://github.com/e2b-dev/secure-computer-use/tree/os-computer-use) ⭐ 2,206 | 🐛 19 | 🌐 Python | 📅 2026-07-09
  * Open-source implementation of computer control capabilities
  * Secure sandboxed environment for AI agents

* [Notte Browser Using Agent](https://github.com/nottelabs/notte) ⭐ 1,993 | 🐛 12 | 🌐 Python | 📅 2026-08-14
...
* [OpenAdapt](https://github.com/OpenAdaptAI/OpenAdapt) ⭐ 1,685 | 🐛 7 | 🌐 Python | 📅 2026-08-15
...
* [dockur/windows](https://github.com/dockur/windows) ⭐ 52,874 | 🐛 17 | 🌐 Shell | 📅 2026-08-17
  * Windows inside a Docker container

* [qemus/qemu-docker](https://github.com/qemus/qemu-docker) ⭐ 2,103 | 🐛 6 | 🌐 Shell | 📅 2026-08-16
  * Docker container for running virtual machines using QEMU

* [E2B Desktop Sandbox](https://github.com/e2b-dev/desktop) ⭐ 1,449 | 🐛 11 | 🌐 Python | 📅 2026-08-17
...
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,662 | 🐛 584 | 🌐 Python | 📅 2024-08-20
  * Cross-platform GUI automation
  * Python-based control library

* [nut.js](https://github.com/nut-tree/nut.js) ⭐ 2,848 | 🐛 43 | 🌐 TypeScript | 📅 2024-05-01
...
For an example of how to format your contribution, please refer to [this PR](https://github.com/francedot/acu/pull/1) ⭐ 1,734 | 🐛 13 | 📅 2025-09-26.
