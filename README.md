...
* [Mobile-Agent-v2: Mobile Device Operation Assistant with Effective Navigation via Multi-Agent Collaboration](https://arxiv.org/abs/2406.01014) (Jun. 2024)
  * [Code](https://github.com/X-PLUG/MobileAgent) ⭐ 9,113 | 🐛 195 | 🌐 Python | 📅 2026-07-07
...
* [UFO: A UI-Focused Agent for Windows OS Interaction](https://arxiv.org/abs/2402.07939) (Feb. 2024)
  * [Code](https://github.com/microsoft/UFO) ⭐ 9,531 | 🐛 77 | 🌐 Python | 📅 2026-08-10
...
* [AppAgent: Multimodal Agents as Smartphone Users](https://arxiv.org/abs/2312.13771) (Dec. 2023)
  * [Code](https://github.com/mnotgod96/AppAgent) ⭐ 6,850 | 🐛 99 | 🌐 Python | 📅 2025-03-19
...
* [OmniParser for Pure Vision Based GUI Agent](https://arxiv.org/pdf/2408.00203) (Aug. 2024)
  * [Code](https://github.com/microsoft/OmniParser) ⭐ 25,292 | 🐛 230 | 🌐 Jupyter Notebook | 📅 2026-07-20
...
* [OSWorld: Benchmarking Multimodal Agents for Open-Ended Tasks in Real Computer Environments](https://arxiv.org/abs/2404.07972) (Apr. 2024)
  * [Code](https://github.com/xlang-ai/OSWorld) ⭐ 3,101 | 🐛 196 | 🌐 Python | 📅 2026-08-21
...
* [τ-bench: A Benchmark for Tool-Agent-User Interaction in Real-World Domains](https://arxiv.org/abs/2406.12045) (Jun. 2024)
  * [Code](https://github.com/sierra-research/tau-bench) ⭐ 1,397 | 🐛 51 | 🌐 Python | 📅 2026-03-18
...
* [Auto-GPT](https://github.com/Significant-Gravitas/Auto-GPT) ⭐ 186,699 | 🐛 510 | 🌐 Python | 📅 2026-08-21
  * Autonomous GPT-4 agent
  * Task automation focus

* [Browser Use](https://github.com/browser-use/browser-use) ⭐ 109,949 | 🐛 365 | 🌐 Python | 📅 2026-08-21
...
* [OpenInterpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,094 | 🐛 4 | 🌐 Rust | 📅 2026-08-20
  * General-purpose computer control framework
  * Python-based, extensible architecture

* [AutoGen](https://github.com/microsoft/autogen) ⭐ 60,556 | 🐛 996 | 🌐 Python | 📅 2026-04-15
...
* [Skyvern](https://github.com/skyvern-ai/skyvern) ⭐ 22,813 | 🐛 215 | 🌐 Python | 📅 2026-08-21
  * AI web agent framework
  * Automate browser-based workflows with LLMs using vision and HTML extraction

* [Self-Operating Computer](https://github.com/OthersideAI/self-operating-computer) ⭐ 10,288 | 🐛 107 | 🌐 Python | 📅 2025-09-19 (Nov. 2023)
  * The first Computer Use framework created
  * Computer control framework
  * Vision-based automation

* [Upsonic](https://github.com/upsonic/upsonic) ⭐ 7,943 | 🐛 31 | 🌐 Python | 📅 2026-06-18
...
* [OpenInterface](https://github.com/AmberSahdev/Open-Interface/) ⭐ 2,713 | 🐛 25 | 🌐 Python | 📅 2026-07-17
  * Open-source UI interaction framework
  * Cross-platform support

* [Open Source Computer Use by E2B](https://github.com/e2b-dev/secure-computer-use/tree/os-computer-use) ⭐ 2,218 | 🐛 19 | 🌐 Python | 📅 2026-07-09
  * Open-source implementation of computer control capabilities
  * Secure sandboxed environment for AI agents

* [Notte Browser Using Agent](https://github.com/nottelabs/notte) ⭐ 1,996 | 🐛 12 | 🌐 Python | 📅 2026-08-20
...
* [OpenAdapt](https://github.com/OpenAdaptAI/OpenAdapt) ⭐ 1,691 | 🐛 2 | 🌐 Python | 📅 2026-08-20
...
* [Grunty](https://github.com/suitedaces/computer-agent) ⭐ 675 | 🐛 9 | 🌐 Rust | 📅 2026-08-13
...
* [dockur/windows](https://github.com/dockur/windows) ⭐ 52,921 | 🐛 19 | 🌐 Shell | 📅 2026-08-21
  * Windows inside a Docker container

* [qemus/qemu-docker](https://github.com/qemus/qemu-docker) ⭐ 2,107 | 🐛 5 | 🌐 Shell | 📅 2026-08-20
  * Docker container for running virtual machines using QEMU

* [E2B Desktop Sandbox](https://github.com/e2b-dev/desktop) ⭐ 1,453 | 🐛 11 | 🌐 Python | 📅 2026-08-20
...
* [PyAutoGUI](https://github.com/asweigart/pyautogui) ⭐ 12,664 | 🐛 584 | 🌐 Python | 📅 2024-08-20
